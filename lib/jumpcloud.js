 ...
 */
JumpCloud.prototype.getAllUserGroups = function (callback){
  makeRequest('GET','/v2/usergroups/?limit=100',{},callback);
};

/**
 * Get group record
 */
JumpCloud.prototype.getGroup = function (groupID, callback){
  makeRequest('GET','/v2/groups/?search=' + groupID,{},callback);
};
 ...
 */
JumpCloud.prototype.getUserGroupMembership = function (userID,callback){
  makeRequest('GET','/v2/users/' + userID + '/memberof',{},callback);
};
